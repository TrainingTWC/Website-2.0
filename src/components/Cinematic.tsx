...
export function CinematicHero({
  ...
  return (
    ...
    >
      ...
      {/* Hero tagline â€” big editorial style below the poster, with scroll parallax */}
      <div className="relative overflow-hidden py-14 sm:py-20 bg-natural-bg">
        {/* Giant ghost wordmark â€” drifts up slower than copy */}
        <motion.div
          style={{ y: tagY }}
        ...
        {/* Foreground copy â€” drifts up faster */}
        <motion.div
